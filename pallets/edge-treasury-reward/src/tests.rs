...
fn setting_treasury_block_reward() {
	new_test_ext().execute_with(|| {
		...
		assert_eq!(
			last_event(),
			mock::Event::TreasuryReward(crate::Event::TreasuryMinting{amount: 9500000, at_block: 1, to: treasury_address.clone()})
		);
		...
		assert_eq!(
			last_event(),
			mock::Event::TreasuryReward(crate::Event::TreasuryMinting{amount: 19000000, at_block: 2, to: treasury_address.clone()})
		);
		...
		assert_eq!(
			last_event(),
			mock::Event::TreasuryReward(crate::Event::TreasuryMinting{amount: 19000095, at_block: 4, to: treasury_address.clone()})
		);
		...
		assert_eq!(
			last_event(),
			mock::Event::TreasuryReward(crate::Event::TreasuryMinting{amount: 19000200, at_block: 8, to: treasury_address.clone()})
		);
		...
		assert_eq!(
			last_event(),
			mock::Event::TreasuryReward(crate::Event::TreasuryMinting{amount: 19000210, at_block: 9, to: treasury_address.clone()})
		);
		...
		assert_eq!(
			last_event(),
			mock::Event::TreasuryReward(crate::Event::TreasuryMinting{amount: 19000220, at_block: 10, to: treasury_address.clone()})
		);
	});
}
